...
<body class="home">
    ...
    <section class="hero bg-image" style="background-image: url('images/img/pimg.jpg');">
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                 <div class="figure-wrap bg-image" style="background-image:url(admin/Res_img/dishes/'.$r['img'].');"></div>
                                                <div class="content">
